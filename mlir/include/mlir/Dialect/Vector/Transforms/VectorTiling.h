//===- VectorTiling.h - Vector Tiling Pass --*- C++------*-===//
//
...
//
//===----------------------------------------------------------------------===//
#ifndef MLIR_DIALECT_VECTOR_TRANSFORMS_VECTORTILING_H_
#define MLIR_DIALECT_VECTOR_TRANSFORMS_VECTORTILING_H_
...
template <class T>
class SpecialOperationCanonicalizer {
private:
